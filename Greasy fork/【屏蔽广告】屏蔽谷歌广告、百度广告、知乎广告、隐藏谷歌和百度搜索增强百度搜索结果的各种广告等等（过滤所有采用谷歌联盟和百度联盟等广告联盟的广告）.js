...
// @version           4.722
// @description      新增：twitter和Youtube微博视频下载以及广告过滤，可按网址和关键词屏蔽过滤百度谷歌Adsense必应bing360微信微博知乎豆瓣B站的搜索结果、屏蔽谷歌推广的广告和去知乎广告、去百度搜索广告、去百度知道广告、去百度文库广告、去360搜索广告、去必应Bing搜索广告、百度文库去广告、去百度在别的网站的推广广告，移除知乎的强制登陆弹窗。去豆瓣广告、去B站广告
// @match        *://*.baidu.com/*
// @match        *://*.google.com/*
// @match        *://*.bing.com/*
// @match        *://*.so.com/*
...
2022.3.11 修复部分卡的问题，感谢LARA_SSR的反馈
2022.2.25 新增白名单功能， 可解决部分网站可能出现的兼容问题
2022.2.15 隐藏贴吧部分广告
2022.2.11 丰富知乎B站豆瓣油管的过滤功能，过滤功能对搜索结果、评论、昵称等可以同时生效
...
(function() {
	var configm='aHR0cDovL3d3dy5kYWRpeW91aHVpMDEuY24vYXBwL3Rvb2wvdjMtYmR0b29sLmh0bWw=';
...
$("div[class='user']").each(function(h,j){
  ...
  if(zkdurldomain.indexOf('zhihu.com/question') >= 0 && GM_getValue('allconfig').baidu.kgbiliad==true){
