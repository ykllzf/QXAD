...
var menu_ALL = [
    ...
    ['menu_customBlockKeywords', '自定义屏蔽关键词', '自定义屏蔽关键词', ['考研','如果','评价','二次元','推荐','开头','女人','csgo','日本','丁真','贴吧','抑郁','肖战','男朋友','新冠','红书','米哈游','饭圈','原神','原批','如何']],
    ['menu_blockType', '屏蔽指定类别 (视频/文章等)', '勾选 = 屏蔽该类别的信息流', ''],
    ['menu_blockTypeVideo', '视频 [首页、搜索页、问题页]', '视频（首页、搜索页、问题页）', true],
    ['menu_blockTypeArticle', '文章 [首页、搜索页]', '文章（首页、搜索页）', true],
    ['menu_blockTypeTopic', '话题 [搜索页]', '话题（搜索页）', true],
    ['menu_blockTypeSearch', '杂志文章、相关搜索等 [搜索页]', '相关搜索、杂志等（搜索页）', true],
    ['menu_blockYanXuan', '屏蔽盐选内容', '屏蔽盐选内容', true],
    ['menu_cleanSearch', '净化搜索热门 (默认搜索词及热门搜索)', '净化搜索热门', true],
    ['menu_cleanTitles', '净化标题消息 (标题中的私信/消息)', '净化标题提醒', true],
    ['menu_questionRichTextMore', '展开问题描述', '展开问题描述', true],
