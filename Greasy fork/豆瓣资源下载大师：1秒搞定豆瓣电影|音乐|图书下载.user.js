...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            if (_version === "完整版") {
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "MTeam", link: 'https://kp.m-team.cc/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + spid, },
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "Hares", link: 'https://club.hares.top/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "GPW", link: 'https://greatposterwall.com/torrents.php?searchstr=' + unititle, selector: ".big_info .group_movie_title" },
            ...
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
                site_map.push({
                    name: "中文影视字幕",
                    label: [
                        { name: '字幕天堂', link: 'https://www.zimutiantang.com/search/?q=' + unititle, selector: '.odd.search' },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: 'RARBT', link: 'http://www.rarbt.co/index.php/search/index.html?search=' + dbzw, selector: 'div.ml div.title' },
            ...
            site_map.push({
                name: "阿里云盘搜索",
                label: [
                    { name: 'T-REX', link: 'https://t-rex.tzfile.com/?s=' + unititle, selector: '.entry-title' },
                    { name: '阿里盘搜', link: 'https://www.alipanso.com/search.html?page=1&keyword=' + unititle, selector: 'h1.resource-title' },
                    { name: '阿里小站', link: 'http://alixiaozhan.com/?q=' + unititle, ajax: "http://alixiaozhan.com/api/discussions?page%5Blimit%5D=3&include=mostRelevantPost&filter%5Bq%5D=" + unititle, type: "json", selector: 'data.length > 0' },
                    { name: '分派电影', link: 'https://ifenpaidy.com/page/' + unititle, selector: '.page-title' },
                    { name: '盘盘资源', link: 'https://www.panpanr.com/search.php?mod=forum&searchsubmit=yes&srchtxt=' + unititle, selector: '#threadlist h3' },
                    { name: '云盘小站', link: 'https://aliyunshare.cn/?q=' + unititle, ajax: "https://aliyunshare.cn/api/discussions?page%5Blimit%5D=3&include=mostRelevantPost&filter%5Bq%5D=" + unititle, type: "json", selector: 'data.length > 0' },
                    { name: '云盘分享', link: 'https://www.yunpan123.com/search.php?mod=forum&searchsubmit=yes&srchtxt=' + unititle, selector: '#threadlist h3' },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: 'NOVIP', link: 'https://www.novipnoad.com/?s=' + unititle, selector: '.item-head h3' },
            ...
            if (has_entitle) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: 'WatchSeri', link: 'https://watchseri.net/search-movies/' + eng_title_clean + '.html', selector: '.iteminfo .title', selector_need_login: "h1 span:contains('Checking your browser')" },
                    ]
                });
            }
            if (is_anime) {
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '19影视', link: 'https://www.19kan.com/vodsearch.html?wd=' + unititle, selector: '.mo-cols-rows h1' },
                    ...
                    { name: '宅腐资源站', link: 'https://www.zhaifu.tv/plus/search.php?kwtype=0&q=' + gunititle, selector: 'div.content a.focus' },
                ]
            });
            site_map.push({
                name: "BT国内网站",
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '小浣熊图书', link: `https://v1.xiaohx.org/search?cat=9&key=${title}`, selector: `div.result_p a[title*='${title}']` },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '小浣熊有声', link: `https://v1.xiaohx.org/search?cat=5&key=${title}`, selector: `div.result_p a[title*='${title}']` },
                ]
            });
